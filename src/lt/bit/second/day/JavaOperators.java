...
//        checkArithmeticsOperations();
//        checkBitwiseOperations();
        checkRelationalOperations();
        checkAssignmentOperations();
        byte a = 1;
        a += 3; // a = ( byte ) (a + 3)
    ...
    private static void checkAssignmentOperations() {
        int number = 23;
...
//        number++;
    ...
    private static void checkRelationalOperations() {
        byte numberOne = 100;
        byte numberTwo = 1;
...
//        numberOne >= numberTwo;
    ...
    private static void checkBitwiseOperations(){
        int numberOne = 5;
...
//        printBinary(numberOne, 32);
    ...
    private static void checkArithmeticsOperations() {
